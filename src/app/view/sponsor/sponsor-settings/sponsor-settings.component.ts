...
import { PageScrollConfig } from 'ng2-page-scroll/src/ng2-page-scroll-config';
...
@Component({
  ...
  templateUrl: './sponsor-settings.component.html',
  styleUrls: ['./sponsor-settings.component.css']
})
